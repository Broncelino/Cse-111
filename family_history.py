...
def print_death_age(people_dict):
    ...
    for i in people_dict:
        death_age = int(people_dict[i][3])-int(people_dict[i][2])
        name = people_dict[i][0]
...
def print_marriages(marriages_dict, people_dict):
    ...
    """
    '''for i in people_dict:
        wedding_age = int(marriages_dict[i][2])-int(people_dict[i][2])
        name = people_dict[i][0]

        print(name, wedding_age)'''
    for i in marriages_dict:
            husband_age = int(marriages_dict[i][2])- int(people_dict[marriages_dict[i][0]][2])
            husband_name = people_dict[marriages_dict[i][0]][0]
            wife_age = int(marriages_dict[i][2])- int(people_dict[marriages_dict[i][1]][2])
            wife_name = people_dict[marriages_dict[i][1]][0]
            wedding_year = marriages_dict[i][2]
           #print(wife_age,wife_name,husband_age,husband_name)
            print(husband_name+" " + str(husband_age)+" > " + str(wedding_year) +" < "+ wife_name + " " + str(wife_age))
    pass
